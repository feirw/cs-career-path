...
export const shortSection1: Section = {
  ...
  questions: [
    ...
    },
    {
      id: "s04",
      section: 1,
      text: { el: "Και από αυτά;", en: "And from these?" },
      options: [
        {
          id: "a",
          label: { el: "Διπλωμάτης", en: "Diplomat" },
          c: { product: 3 },
          t: { people: 3, product: 1 },
        },
        {
          id: "b",
          label: { el: "Υπεύθυνος μηχανοστασίου σε πλοίο", en: "Ship's engine-room chief" },
          c: { devops: 3, backend: 1 },
          t: { ops: 3 },
        },
        {
          id: "c",
          label: { el: "Αρχειοθέτης μεγάλης βιβλιοθήκης", en: "Archivist of a great library" },
          c: { dataeng: 3, datasci: 1 },
          t: { ops: 2, analytical: 1 },
        },
        {
          id: "d",
          label: { el: "Ελεγκτής ποιότητας", en: "Quality inspector" },
          c: { qa: 3, security: 1 },
          t: { adversarial: 2, ops: 1 },
        },
        {
          id: "e",
          label: { el: "Δάσκαλος", en: "Teacher" },
  ...
  questions: [
    {
      ...
      options: [
        {
          id: "a",
          label: { el: "Κάτι που κρατάς στο χέρι σου", en: "Something you hold in your hand" },
          c: { mobile: 3, frontend: 1 },
          t: { creative: 2 },
        },
        {
          id: "b",
          label: { el: "Μια μηχανή με κινούμενα μέρη", en: "A machine with moving parts" },
          c: { embedded: 3 },
          t: { systems: 3 },
        },
        {
          id: "c",
          label: { el: "Ένα δίκτυο που απλώνεται παντού", en: "A network that reaches everywhere" },
          c: { devops: 3, backend: 1 },
          t: { ops: 3 },
        },
        {
          id: "d",
          label: { el: "Ένα τεράστιο αρχείο με στοιχεία", en: "An enormous archive of records" },
          c: { dataeng: 3, datasci: 1 },
