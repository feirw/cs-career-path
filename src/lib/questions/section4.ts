...
export const section4: Section = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: "a", label: { el: "Συμφωνώ απόλυτα", en: "Strongly agree" }, c: { product: 18, devops: 14, backend: 10, mobile: 8, dataeng: 6, frontend: 4, datasci: 3, ml: 3, embedded: 8, security: 1, qa: 1, research: 1 } },
        { id: "b", label: { el: "Συμφωνώ", en: "Agree" }, c: { product: 14, devops: 11, backend: 8, mobile: 6, dataeng: 5, frontend: 3, datasci: 3, ml: 2, embedded: 8, security: 1, qa: 1, research: 1 } },
        { id: "c", label: { el: "Ουδέτερο", en: "Neutral" }, c: { product: 8, devops: 6, backend: 5, mobile: 5, dataeng: 4, frontend: 3, datasci: 3, ml: 3, embedded: 8, security: 2, qa: 2, research: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "b", label: { el: "Συμφωνώ", en: "Agree" }, c: { frontend: 14, mobile: 11, product: 8, backend: 6, datasci: 5, dataeng: 3, ml: 3, embedded: 8, qa: 2, security: 1, devops: 1, research: 1 } },
        { id: "c", label: { el: "Ουδέτερο", en: "Neutral" }, c: { frontend: 8, mobile: 6, product: 5, backend: 5, datasci: 4, dataeng: 3, ml: 3, embedded: 8, qa: 2, security: 2, devops: 2, research: 2 } },
    ...
    },
    {
      ...
      options: [
        { id: "a", label: { el: "Συμφωνώ απόλυτα", en: "Strongly agree" }, c: { frontend: 18, datasci: 14, product: 10, mobile: 8, dataeng: 6, backend: 4, ml: 3, devops: 3, qa: 2, security: 1, embedded: 5, research: 1 } },
        { id: "b", label: { el: "Συμφωνώ", en: "Agree" }, c: { frontend: 14, datasci: 11, product: 8, mobile: 6, dataeng: 5, backend: 3, ml: 3, devops: 2, qa: 2, security: 1, embedded: 5, research: 1 } },
        { id: "c", label: { el: "Ουδέτερο", en: "Neutral" }, c: { frontend: 8, datasci: 6, product: 5, mobile: 5, dataeng: 4, backend: 3, ml: 3, devops: 3, qa: 2, security: 2, embedded: 8, research: 2 } },
    ...
    },
    {
      ...
      options: [
        { id: "a", label: { el: "Συμφωνώ απόλυτα", en: "Strongly agree" }, c: { mobile: 18, frontend: 14, product: 10, backend: 8, datasci: 6, dataeng: 4, devops: 3, ml: 3, embedded: 8, security: 1, qa: 1, research: 1 } },
        { id: "b", label: { el: "Συμφωνώ", en: "Agree" }, c: { mobile: 14, frontend: 11, product: 8, backend: 6, datasci: 5, dataeng: 3, devops: 3, ml: 2, embedded: 8, security: 1, qa: 1, research: 1 } },
        { id: "c", label: { el: "Ουδέτερο", en: "Neutral" }, c: { mobile: 8, frontend: 6, product: 5, backend: 5, datasci: 4, dataeng: 3, devops: 3, ml: 2, embedded: 8, security: 2, qa: 2, research: 2 } },
        { id: "d", label: { el: "Διαφωνώ", en: "Disagree" }, c: { backend: 10, devops: 8, embedded: 6, security: 5, qa: 4, dataeng: 3, research: 3, datasci: 2, ml: 2, frontend: 1, mobile: 1, product: 1 } },
        { id: "e", label: { el: "Διαφωνώ απόλυτα", en: "Strongly disagree" }, c: { backend: 16, embedded: 10, devops: 8, research: 6, security: 5, qa: 3, dataeng: 2, datasci: 2, ml: 2, frontend: 1, mobile: 1, product: 1 } }
      ]
    },
